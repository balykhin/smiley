...
Ext.define('Ext.Rating', {
    ...
    * @param {Ext.Rating} this This field
    ...
    */
    ...
    initialize: function () {
        ...
        var me = this;
        Ext.Rating.superclass.initialize.apply(me, arguments);
    ...
    */
     ...
     */
    Ext.deprecateProperty(this, 'showClear', 'clearIcon', "Ext.Rating.showClear has been removed, use showClear instead");
     ...
     * @removed 2.0.0
     */
    Ext.deprecateProperty(this, 'singleColorPerValue', null, "Ext.Rating.singleColorPerValue has been removed");
